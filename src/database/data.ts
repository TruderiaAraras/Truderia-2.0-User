...
export const menuView = [
  ...
  {
    name: "TRUDEL FINGERS (EVENTOS/FESTAS/PRESENTE)",
    category: "fingers",
    items: [
      {
        flavour: "TRUDEL BOX",
      ...
      },
      {
        ...
        span: "",
        description:
          "Nossos irresistíveis trudels, no tamanho ideal (35 gramas) para surpreender seus convidados e deixar sua mesa de doces simplesmente maravilhosa em seu evento. Apenas encomendas. (1 semana de antecedência)",
